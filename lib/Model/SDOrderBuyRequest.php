...
/**
 * SDOrderBuyRequest Class Doc Comment
 *
 * @category Class
 * @package  Stardust\Core
 * @author   OpenAPI Generator team
 ...
 */
class SDOrderBuyRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SDOrderBuyRequest';
    ...
    */
    ...
    public function setOrderId($order_id)
    {
        ...
        if (($order_id > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $order_id when calling SDOrderBuyRequest., must be smaller than or equal to 2147483647.');
        }
        if (($order_id < 0)) {
            throw new \InvalidArgumentException('invalid value for $order_id when calling SDOrderBuyRequest., must be bigger than or equal to 0.');
        }
     ...
     * Sets accepted_by
     *
     * @param string $accepted_by The player who accepted the order
     *
     * @return self
     */
