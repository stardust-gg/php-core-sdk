...
/**
 * SDPlayerCreateJWTObject Class Doc Comment
 *
 * @category Class
 * @package  Stardust\Core
 * @author   OpenAPI Generator team
 ...
 */
class SDPlayerCreateJWTObject implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SDPlayerCreateJWTObject';
    ...
    */
     ...
     * Sets type
     *
     * @param string $type Your provider JWT name
     *
     * @return self
     */
     ...
     * Sets id_token
     *
     * @param string|null $id_token idToken of the user session
     *
     * @return self
     */
     ...
     * Sets access_token
     *
     * @param string|null $access_token Access token of the user session
     *
     * @return self
     */
