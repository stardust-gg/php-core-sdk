...
/**
 * SDPlayerMutateRequest Class Doc Comment
 *
 * @category Class
 * @package  Stardust\Core
 * @author   OpenAPI Generator team
 ...
 */
class SDPlayerMutateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SDPlayerMutateRequest';
    ...
    */
     ...
     * Sets player_id
     *
     * @param string $player_id Can be found with Player/getId(s).
     *
     * @return self
     */
