...
/**
 * SDTokenMintBulkTokenObject Class Doc Comment
 *
 * @category Class
 * @package  Stardust\Core
 * @author   OpenAPI Generator team
 ...
 */
class SDTokenMintBulkTokenObject implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SDTokenMintBulkTokenObject';
    ...
    protected static $openAPITypes = [
        'template_id' => 'int',
        'amount' => 'string',
        'props' => '\Stardust\Core\Stardust\Core\Model\SDTokenMintBulkTokenObjectProps',
    ...
    */
     ...
     * Sets template_id
     *
     * @param int $template_id Specifies which Template you are creating an instance of (ex. 3)
     *
     * @return self
     */
    public function setTemplateId($template_id)
    {
        ...
        if (($template_id > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $template_id when calling SDTokenMintBulkTokenObject., must be smaller than or equal to 2147483647.');
        }
        if (($template_id < 0)) {
            throw new \InvalidArgumentException('invalid value for $template_id when calling SDTokenMintBulkTokenObject., must be bigger than or equal to 0.');
        }
     ...
     * Gets props
     *
     * @return \Stardust\Core\Stardust\Core\Model\SDTokenMintBulkTokenObjectProps|null
     */
     ...
     * Sets props
     *
     * @param \Stardust\Core\Stardust\Core\Model\SDTokenMintBulkTokenObjectProps|null $props props
     *
     * @return self
     */
