...
/**
 * SDGameMutateRequest Class Doc Comment
 *
 * @category Class
 * @package  Stardust\Core
 * @author   OpenAPI Generator team
 ...
 */
class SDGameMutateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SDGameMutateRequest';
    ...
    */
     ...
     * Sets description
     *
     * @param string|null $description The games description
     *
     * @return self
     */
     ...
     * Sets news
     *
     * @param string|null $news The games news
     *
     * @return self
     */
     ...
     * Sets test_mode
     *
     * @param bool|null $test_mode Test mode will enable any test mode features. Currently in development.
     *
     * @return self
     */
