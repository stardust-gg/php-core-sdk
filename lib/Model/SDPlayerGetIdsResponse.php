...
/**
 * SDPlayerGetIdsResponse Class Doc Comment
 *
 * @category Class
 ...
 */
class SDPlayerGetIdsResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SDPlayerGetIdsResponse';
    ...
    */
     ...
     * Sets unique_id
     *
     * @param string $unique_id Player ID in the form of a the game player's internal playerId, i.e. email address, uuid
     *
     * @return self
     */
