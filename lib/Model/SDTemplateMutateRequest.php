...
/**
 * SDTemplateMutateRequest Class Doc Comment
 *
 * @category Class
 * @package  Stardust\Core
 * @author   OpenAPI Generator team
 ...
 */
class SDTemplateMutateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SDTemplateMutateRequest';
    ...
    */
     ...
     * Sets template_id
     *
     * @param int $template_id This is the templateId returned from template/create (ex. 5)
     *
     * @return self
     */
    public function setTemplateId($template_id)
    {
        ...
        if (($template_id > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $template_id when calling SDTemplateMutateRequest., must be smaller than or equal to 2147483647.');
        }
        if (($template_id < 0)) {
            throw new \InvalidArgumentException('invalid value for $template_id when calling SDTemplateMutateRequest., must be bigger than or equal to 0.');
        }
     ...
     * Sets props
     *
     * @param object|null $props Specifies which properties you want to change (ex. {prop1: 5, prop2: 6, prop3: 7})
     *
     * @return self
     */
