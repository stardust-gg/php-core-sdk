...
/**
 * SDTemplateGetAllResponse Class Doc Comment
 *
 * @category Class
 * @package  Stardust\Core
 * @author   OpenAPI Generator team
 ...
 */
class SDTemplateGetAllResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SDTemplateGetAllResponse';
    ...
    */
    ...
    public function setGameId($game_id)
    {
        ...
        if (($game_id > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $game_id when calling SDTemplateGetAllResponse., must be smaller than or equal to 2147483647.');
        }
        if (($game_id < 0)) {
            throw new \InvalidArgumentException('invalid value for $game_id when calling SDTemplateGetAllResponse., must be bigger than or equal to 0.');
        }
    ...
    public function setId($_id)
    {
        ...
        if (($_id > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $_id when calling SDTemplateGetAllResponse., must be smaller than or equal to 2147483647.');
        }
        if (($_id < 0)) {
            throw new \InvalidArgumentException('invalid value for $_id when calling SDTemplateGetAllResponse., must be bigger than or equal to 0.');
        }
