...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://core-api.stardust.gg/v1';
     ...
     * @var string
     */
    protected $userAgent = 'OpenAPI-Generator/0.0.3/PHP';
    ...
    {
        $report  = 'PHP SDK (Stardust\Core) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    The version of the OpenAPI document: 2023-05-08T04:33:59Z' . PHP_EOL;
